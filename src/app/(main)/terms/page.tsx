  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="p-8 rounded-3xl bg-slate-900/80 border border-amber-500/15 shadow-2xl space-y-6 text-xs sm:text-sm text-slate-300 leading-relaxed">
        <h2 className="text-lg font-bold text-amber-300">১. ব্যবহারের যোগ্যতা</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-amber-300">২. ইসলামিক শিষ্টাচার ও নৈতিকতা</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-amber-300">৩. মেম্বারশিপ ও পেমেন্ট নীতি</h2>
        <p>
